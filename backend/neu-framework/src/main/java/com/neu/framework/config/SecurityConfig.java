package com.neu.framework.config;
...
import com.neu.framework.security.filter.JwtAuthenticationTokenFilter;
import com.neu.framework.security.handle.AuthenticationEntryPointImpl;
import com.neu.framework.security.handle.LogoutSuccessHandlerImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] PERMIT_LIST = {"/api/code", "/api/user/check", "/api/user/setPwd", "/api/adv/list", "/carbonReport/**"
            , "/material/materialInventory/**", "/bid/bidding/front/list", "/bid/bidding/front/{id}", "/bid/information/front/list", "/bid/information/front/{id}"
