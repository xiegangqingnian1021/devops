    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button v-no-more-click type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd" v-hasPermi="['system:user:add']">新增</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button v-no-more-click type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate" v-hasPermi="['system:user:edit']">修改</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button v-no-more-click type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete" v-hasPermi="['system:user:remove']">删除</el-button>
          </el-col>
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="婚姻状况" align="center" prop="marriage" :formatter="marriageFormat" />
          <el-table-column label="文化程度" align="center" prop="degree" :formatter="degreeFormat" />
          ...
          <el-table-column label="操作" align="center" width="160" class-name="small-padding fixed-width">
            <template slot-scope="scope">
              <el-button v-no-more-click size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)" v-hasPermi="['system:user:edit']">修改</el-button>
              <el-button v-no-more-click v-if="scope.row.userId !== 1" size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)" v-hasPermi="['system:user:remove']">删除</el-button>
              <el-button v-no-more-click size="mini" type="text" icon="el-icon-key" @click="handleResetPwd(scope.row)" v-hasPermi="['system:user:resetPwd']">重置</el-button>
            </template>
          </el-table-column>
        </el-table>
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="出生日期" prop="birthday">
              <el-date-picker clearable size="small" v-model="form.birthday" type="date" value-format="yyyy-MM-dd" placeholder="选择出生日期">
              </el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="户籍地址" prop="registerPlace">
              <el-input v-model="form.registerPlace" placeholder="请输入户籍地址" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="文化程度" prop="degree">
              <el-select v-model="form.degree" placeholder="请选择文化程度">
                <el-option v-for="dict in degreeOptions" :key="dict.dictValue" :label="dict.dictLabel" :value="dict.dictValue"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="婚姻状况" prop="marriage">
              <el-select v-model="form.marriage" placeholder="请选择婚姻状况">
                <el-option v-for="dict in marriageOptions" :key="dict.dictValue" :label="dict.dictLabel" :value="dict.dictValue"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="紧急联系人" prop="contacts">
              <el-input v-model="form.contacts" placeholder="请输入紧急联系人" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
export default {
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: this.getBaseUrl() + "/system/user/importData"
      },
      // 查询参数
      queryParams: {
        pageNum: 1,
  ...
  created() {
    ...
    this.getDicts("sys_degree").then(response => {
      this.degreeOptions = response.data;
    });
    this.getDicts("sys_marriage").then(response => {
